...
describe('JSON RPC', function () {
    ...
    beforeEach(function () {
        ...
        jsonRpc = new icbsc_jsonrpc_1.JsonRpc(endpointExtraSlash);
    });
    it('throws error bad status', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4, jsonRpc.get_abi(accountName)];
                case 2:
                    _a.sent();
                    return [3, 4];
                case 3:
                    e_1 = _a.sent();
                    expect(e_1).toBeInstanceOf(icbsc_rpcerror_1.RpcError);
    ...
    it('throws error unprocessed', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    e_2 = _a.sent();
                    expect(e_2).toBeInstanceOf(icbsc_rpcerror_1.RpcError);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    jsonRpc = new icbsc_jsonrpc_1.JsonRpc(endpoint, { fetch: myFetch });
                    return [4, jsonRpc.get_abi(accountName)];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_account(accountName)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_block_header_state(blockNumOrId)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_block(blockNumOrId)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_code(accountName)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_currency_balance(code, account, symbol)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_currency_balance(code, account)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_currency_stats(code, symbol)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_producer_schedule()];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_producers(json, lowerBound, limit)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_producers()];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_raw_code_and_abi(accountName)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_scheduled_transactions()];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_table_rows(callParams)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.get_table_by_scope(callParams)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.getRequiredKeys(callParams)];
                case 1:
                    response = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.push_transaction(callParams)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
    ...
    it('calls send_transaction', function () { return __awaiter(_this, void 0, void 0, function () {
        var expPath, signatures, serializedTransaction, limit, expReturn, callParams, expParams, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.send_transaction(callParams)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.history_get_actions(accountName, pos, offset)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.history_get_actions(accountName)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.history_get_transaction(id, blockNumHint)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.history_get_transaction(id)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.history_get_key_accounts(publicKey)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4, jsonRpc.history_get_controlled_accounts(controllingAccount)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
...
//# sourceMappingURL=icbsc-jsonrpc.test.js.map