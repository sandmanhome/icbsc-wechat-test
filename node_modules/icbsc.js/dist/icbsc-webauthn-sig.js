...
var WebAuthnSignatureProvider = (function () {
    ...
    WebAuthnSignatureProvider.prototype.getAvailableKeys = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, Array.from(this.keys.keys())];
            });
        });
    };
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    case 0:
                        ...
                        if (!serializedContextFreeData) return [3, 2];
                        _d = (_c = signBuf).pushArray;
                        _e = Uint8Array.bind;
                        return [4, crypto.subtle.digest('SHA-256', serializedContextFreeData.buffer)];
                    case 1:
                    ...
                    case 3:
                        _f = Uint8Array.bind;
                        return [4, crypto.subtle.digest('SHA-256', signBuf.asUint8Array().slice().buffer)];
                    case 4:
                    ...
                    case 5:
                        ...
                        _l.label = 6;
                    case 6:
                        if (!!requiredKeys_1_1.done) return [3, 11];
                    ...
                    case 7:
                        ...
                        _j = Uint8Array.bind;
                        return [4, crypto.subtle.digest('SHA-256', assertion.response.clientDataJSON)];
                    case 8:
                        _h.apply(_g, [new (_j.apply(Uint8Array, [void 0, _l.sent()]))()]);
                        _k = Uint8Array.bind;
                        return [4, crypto.subtle.digest('SHA-256', whatItReallySigned.asUint8Array().slice())];
                    case 9:
                    ...
                    case 13:
                        ...
                        return [7];
                    case 14: return [2, { signatures: signatures, serializedTransaction: serializedTransaction, serializedContextFreeData: serializedContextFreeData }];
                }
            });
        });
    };
...
//# sourceMappingURL=icbsc-webauthn-sig.js.map